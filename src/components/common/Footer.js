                ...
                <div className="container p-6 pb-4 mx-auto">
                    <div className="lg:flex">
                        <div className="w-full -mx-6 lg:w-1/2">
                            <div className="px-6">
                                <div>
                                    <a href="/" className="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Tasker</a>
                                </div>

                                <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400">Helping you to Make your life Sorted and Easier</p>
                        ...
                        <div className="mt-6 lg:mt-0 lg:flex-1">
                            <div className="grid grid-cols-2 gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+91 7727998598</span>
                    ...
                    <div>
                        <p className="text-center text-gray-500 dark:text-gray-400">© Tasker 2022 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </>
